...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Person person1 = new Person("Andrea",24,"Via XXIV maggio");
    ...
    private static void exercise2() {
        ...
        // Your code here
        Person person1 = new Person("Andrea",24,"Via XXIV maggio");
        Person person2 = new Person("Baschirotto",28,"Via Lecce");
        System.out.println("persona 1: " + person1.hashCode());
        System.out.println("persona 2: " + person2.hashCode());
    }
