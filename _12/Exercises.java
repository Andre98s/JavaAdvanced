...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        ourNumbers.stream().filter(integer -> integer % 2 ==0)
    ...
    private static void exercise4() {
        ...
        Set<Integer> evenNumbers = ourNumbers.stream().filter(integer -> integer % 2 ==0).map(integer -> integer * 2).collect(Collectors.toSet());
